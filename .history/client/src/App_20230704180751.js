...
const App = () => {
  ...
  const onGoogleApiLoaded = ({ map, maps }) => {
    ...
    const mmarkers = [38.283, 39.2932];

    console.log(renderedMarkers);
    console.log("are markers");
  ...
  const updateRenderedMarkers = (filteredMarkers) => {
    setRenderedMarkers(filteredMarkers.map(
  ...
  // Call the updateRenderedMarkers function with the filtered markers
  updateRenderedMarkers(filteredMarkersToShow);
