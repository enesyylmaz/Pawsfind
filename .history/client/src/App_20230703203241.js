...
const App = () => {
  ...
  const onGoogleApiLoaded = ({ map, maps }) => {
    ...
    //maps.event.addListener(map, "dragend", handleMapDrag);
  };
  ...
  // Assuming you have a map object called 'map'
  map.addListener("dragstart", handleMapDragStart);
            ...
            <div className="form-container flex items-center justify-center">
              ...
              >
                <div className="grid place-items-center">
                  <div className="map2-container relative">
                    <GoogleMap
                      apiKey="AIzaSyCpSbd_GTUT5hRGzW-BBK6mXYX_quZ6ZOQ"
                      defaultCenter={{ lat: 38.315463, lng: 26.638829 }}
                      defaultZoom={9}
