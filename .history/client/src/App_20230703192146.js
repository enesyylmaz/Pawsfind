...
const App = () => {
  ...
  const onMarkerClick = (
    e,
    { markerId, lat, lng, markerDescription, markerVariant, petImage, markerEmail }
  ) => {
    setHighlighted({
      markerId,
      lat,
  ...
  return (
    <main>
      ...
      <div className="map-container" ref={mapContainerRef}>
        ...
        >
          {filteredMarkers.map(
            ({ lat, lng, name, variant, email, description, image }, index) => {
        ...
        <div className="popup">
          <div className="popup-content">
            <div className="popup-header">
              <h3>
                {highlighted.markerVariant} Pet {highlighted.markerId} reported by {highlighted.markerEmail.split("@").[0]}
                by
              </h3>
              <button
                type="button"
            ...
            <p>Description: {highlighted.markerDescription}</p>
            <p>Email: {highlighted.markerEmail}</p>
          </div>
        </div>
      )}
      {showPopup && (
