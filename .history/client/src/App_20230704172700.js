...
import { MarkerClusterer } from "marker-clusterer-library";
import { SuperClusterAlgorithm } from "super-cluster-algorithm-library";
...
const App = () => {
  ...
  const renderMarkerClusterer = () => {
    console.log(window.SuperClusterAlgorithm);
    console.log(window.MarkerClusterer + " not super");
    if (window.MarkerClusterer && window.SuperClusterAlgorithm) {
      console.log("i am working");
      new window.MarkerClusterer({
        filteredMarkersToShow,
        mapRef,
        algorithm: new window.SuperClusterAlgorithm({ radius: 200 }),
      });
    }
  };
