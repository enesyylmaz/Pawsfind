...
const App = () => {
  ...
  const filterMarkersUsingTags = (tags) => {
    if (!tags || tags.length === 0) {
      ...
      return filteredMarkersToShow.filter(({ markerTags }) => {
        // Check if any of the tags in the markerTags array match the provided tags
        return markerTags.some((markerTag) => tags.includes(markerTag));
      });
    }
  };
