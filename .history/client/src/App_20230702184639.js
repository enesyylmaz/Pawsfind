...
const App = () => {
  ...
  const [entryData, setEntryData] = useState({ title: "", description: "" });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Perform any necessary action with the entry data
    console.log(entryData);
    setEntryData({ title: "", description: "" });
    closePopup();
  };
          ...
          <div className="popup-content">
            ...
            <div className="popup-body">
              <form
                ...
                className="flex flex-col items-center justify-start w-1/2 h-5/8"
              >
                <input
                  type="text"
                  placeholder="Name"
