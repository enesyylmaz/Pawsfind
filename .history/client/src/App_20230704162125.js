...
const App = () => {
  ...
  const onGoogleApiLoaded = ({ map, maps }) => {
    ...
    const MarkerClusterer = maps.MarkerClusterer;
    const SuperClusterAlgorithm = maps.SuperClusterAlgorithm;
      ...
      {highlighted && (
        <div className="popup">
          <div className="popup-content">
            ...
            <br />
            {highlighted.markerEmail === profile.email && (
              <button className="add_button" onClick={handleRemove}>
                Remove Report
              </button>
            )}
          </div>
